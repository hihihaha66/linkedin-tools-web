...
try{
 for(const [label,width,height] of [['desktop',1280,900],['mobile-320',320,740],['mobile-375',375,812],['mobile-430',430,932]]){
  ...
  if((await page.title()).includes('V2')||!(await page.title()).includes('V3'))throw new Error(label+': V3 page title/version drift '+await page.title());
  ...
  const dateBodyCount=bodies.length;
